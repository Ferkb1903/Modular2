...
# Solo graficaremos el plano central (Z=0), puedes cambiar esto.
# Es importante usar una tolerancia pequeña al comparar números de punto flotante
z_corte = 0.0
...
if not df_plano_central.empty:
    ...
    plt.xlabel('X (mm)')
    plt.ylabel('Y (mm)')
    plt.title(f'Mapa 2D de Deposición de Energía (Z={z_corte})')
